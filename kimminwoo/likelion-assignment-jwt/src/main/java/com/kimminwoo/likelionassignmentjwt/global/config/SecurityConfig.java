package com.kimminwoo.likelionassignmentjwt.global.config;

import com.kimminwoo.likelionassignmentjwt.global.jwt.JwtAuthorizationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        ...
                        .requestMatchers("/users/**").permitAll() // members로 시작하는 경로는 허용
                        .requestMatchers("/tasks/**").permitAll() // posts도 허용
